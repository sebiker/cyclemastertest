...
export class HomePage {
  ...
  constructor(private readonly page: Page) {
    ...
    this.componenteLink = page.locator('a:has-text("Componente")').first();
    this.transmisieLink = page.locator('a:has-text("Transmisie")').first();
    this.franeLink = page.locator('a:has-text("Frane")').first();
    this.rotiLink = page.locator('a:has-text("Roti")').first();
    this.accesoriiLink = page.locator('a:has-text("Accesorii")').first();
